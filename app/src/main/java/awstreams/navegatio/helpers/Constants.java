package awstreams.navegatio.helpers;
...
public class Constants {
    ...
    public static final String URL = "http://navegatio.com/";
    public static final String URL_BASE = "http://navegatio.com/api-aZqaJu6TUUfA/";
